...
Version  : 0.1.7
Release  : 11
URL      : https://cran.r-project.org/src/contrib/C50_0.1.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/C50_0.1.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668011288
